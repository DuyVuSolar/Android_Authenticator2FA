 ...
 * @date 2018-01-05
 */
open class StickerRender(protected var mContext: Context) : FilterRender() {//watermark, arrow... use for default position
    // Sticker Model
    ...
    override fun onDraw() {
        ...
        for (componentRender in mComponentRenders) {
            ...
            componentRender.onDraw(mTextureHandle, mPositionHandle, mTextureCoordHandle, mTextureVertices[2]!!, 0, 0, isRecording, isHide, totalScore)
        }
