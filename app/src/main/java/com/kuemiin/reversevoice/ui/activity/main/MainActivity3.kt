...
import com.kuemiin.reversevoice.databinding.ActivityMain2Binding
...
class MainActivity3 : AppCompatActivity() {
    ...
    private fun loadNative(incrementCount: Boolean = true) {
        ...
        val adLoader = AdLoader.Builder(this, MaxUtils.AD_UNIT_ID_NATIVE_FULLSPLASH)
            ...
            .withAdListener(object : AdListener() {
                ...
                override fun onAdLoaded() {
                    ...
                    if (MaxUtils.count % MaxUtils.getCount(this@MainActivity3) == 0) {
                        ...
                        binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
                            width = dpToPx(this@MainActivity3, 20)
                            height = dpToPx(this@MainActivity3, 20)
                        }
                    }
