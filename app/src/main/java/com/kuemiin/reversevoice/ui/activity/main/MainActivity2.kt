...
class MainActivity2 : AppCompatActivity() {
    ...
    private fun loadNative(incrementCount: Boolean = true) {
        ...
        val adLoader = AdLoader.Builder(this, MaxUtils.AD_UNIT_ID_NATIVE_FULL)
            ...
            .withAdListener(object : AdListener() {
                ...
                override fun onAdLoaded() {
                    ...
                    if (MaxUtils.count % MaxUtils.getCount(this@MainActivity2) == 0) {
                        ...
                        binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
                            width = dpToPx(this@MainActivity2, 20)
                            height = dpToPx(this@MainActivity2, 20)
                        }
                    }
