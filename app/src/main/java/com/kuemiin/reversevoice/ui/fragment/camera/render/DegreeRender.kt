 ...
 * @date 2018-05-25
 */
class DegreeRender(context: Context, val widthRender : Int, val typeFilter : String) : QuestionRender(context) {
    ...
    init {
        ...
        component.src = "${CanvasFileFilter.getFilterFormatFile("typeFilter")}/${CanvasFileFilter.folderTime}"
