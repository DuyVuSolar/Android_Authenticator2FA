...
import com.kuemiin.reversevoice.utils.refresh.Util.dip2px
import com.kuemiin.reversevoice.utils.refresh.Util.limitValue

class MaterialHeadView @JvmOverloads constructor(
    context: Context,
    ...
    private val listener: com.kuemiin.reversevoice.utils.refresh.MaterialHeadListener? = null
