package com.kuemiin.reversevoice
...
import com.kuemiin.base.BaseApplication
import com.kuemiin.reversevoice.ui.activity.main.GlobalOverlayTimerManager
import com.kuemiin.reversevoice.utils.LocaleHelper.dLocale
import com.kuemiin.reversevoice.utils.MaxUtils
import com.kuemiin.reversevoice.utils.MaxUtils.TYPEX
import com.kuemiin.reversevoice.utils.MaxUtils.logFirebaseEvent
import com.kuemiin.reversevoice.utils.extension.initBaseApplication
import dagger.hilt.android.HiltAndroidApp
import timber.log.Timber
import java.util.Locale

@HiltAndroidApp
class BaseApplication : BaseApplication(), Application.ActivityLifecycleCallbacks,
...
//        GlobalOverlayTimerManager.registerLifecycleCallbacks(this)
    ...
    companion object {
        ...
        @Volatile
        lateinit var instance: com.kuemiin.reversevoice.BaseApplication

        @JvmStatic
        fun getAppInstance(): com.kuemiin.reversevoice.BaseApplication = instance

        var cameraFacing = CameraSelector.LENS_FACING_FRONT
        var effectFilter = Bitmap2025QuizFilter.EFFECT_SING_A_SONG
