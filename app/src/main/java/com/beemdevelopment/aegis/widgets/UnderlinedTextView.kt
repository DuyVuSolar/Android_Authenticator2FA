...
import com.beemdevelopment.aegis.widgets.UnderlinedTextView.UnderLinePosition.Companion.POSITION_BASELINE
import com.beemdevelopment.aegis.widgets.UnderlinedTextView.UnderLinePosition.Companion.POSITION_BELOW
    ...
    override fun onDraw(canvas: Canvas) {
        canvas.takeIf { !text.isNullOrEmpty() }?.let {
            ...
            for (i in 0 until count) {
                ...
                xStart = layout.getPrimaryHorizontal(firstCharInLine) + resources.getDimensionPixelOffset(com.intuit.sdp.R.dimen._10sdp)
                xStop = layout.getPrimaryHorizontal(lastCharInLine - offset) + resources.getDimensionPixelOffset(com.intuit.sdp.R.dimen._10sdp)
